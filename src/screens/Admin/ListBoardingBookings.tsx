...
export default function ListBoardingBookings({
  navigation,
}: {
  navigation: any;
}) {
  ...
  const loadBookings = useCallback(async () => {
    ...
    try {
      ...
      console.warn('Failed to load boarding bookings:', error);
    } finally {
      if (mounted) {
        setLoading(false);
        setRefreshing(false);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Boarding Bookings ({bookings.length})
        </Text>
      </View>
